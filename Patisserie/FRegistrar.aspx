<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRegistrar.aspx.cs" Inherits="Patisserie.FRegistrar" %>
...
<body>
    <article>
      <h1 class="auto-style16">Registrarse</h1>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style12">
                        <asp:TextBox ID="TextBoxEmail" runat="server" CssClass="textbox1" Height="23px"></asp:TextBox>
                        </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style5">
                        <asp:TextBox ID="TextBoxPasswordR" runat="server" CssClass="textbox1" Height="21px" TextMode="Password"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style8"></td>
                    <td class="auto-style9">
                        <asp:Button ID="ButtonRegistrar" runat="server" Text="Registrar" CssClass="btn" OnClick="ButtonIngresar_Click" />
                    </td>
